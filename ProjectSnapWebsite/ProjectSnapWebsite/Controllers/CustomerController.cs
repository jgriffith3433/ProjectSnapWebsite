...
using DAL;
using ProjectSnapWebsite.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using ProjectSnapWebsite.Helpers;

namespace ProjectSnapWebsite.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from ProjectSnapWebsite", message);
